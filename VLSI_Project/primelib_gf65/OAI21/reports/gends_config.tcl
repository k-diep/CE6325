...
define_parameters -append ioreport {
    ...
    set dccurrent_table_title {<font size="+1">DC CURRENT</font>}
    ...
    set clock_cond_table_title {<font size="+1">CLOCK CONDITION</font>}
    set preset_cond_table_title {<font size="+1">PRESET CONDITION</font>}
    set clear_cond_table_title {<font size="+1">CLEAR CONDITION</font>}
    set ret_cond_table_title {<font size="+1">RETENTION CONDITION</font>}
...
define_parameters -append ioreport {
    ...
    set nochange_constraint_headers {
        "Constraint Pin"
        "Related Pin"
        "Constraint Pin Tin (@@time_unit@@)"
        "Related Pin Tin (@@time_unit@@)"
        "Nochange_setup (@@time_unit@@)"
        "Nochange_hold (@@time_unit@@)"
    }
    set mpw_headers {
        "Constraint Pin"
        "Related Pin"
    ...
    set dc_current_headers {
        "Related Switch Pin"
        "Related Pg Pin"
        "Related Internal Pg Pin"
        "Input Voltage (@@voltage_unit@@)"
        "Output Voltage (@@voltage_unit@@)"
