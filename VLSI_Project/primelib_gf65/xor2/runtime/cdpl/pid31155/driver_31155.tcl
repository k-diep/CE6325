if { [catch {
set_location /home/012/k/kt/ktd170030/cad/gf65/primelib_gf65/xor2
...
if {[catch {
  ...
  reset_log_file
  if { [log_num_errors] > 0 } {
    if { [catch {exec mv -f $sis_log_file /home/012/k/kt/ktd170030/cad/gf65/primelib_gf65/xor2/runtime/cdpl/pid31155} mv_err] } {
      log_warning $mv_err
    }
  } else {
